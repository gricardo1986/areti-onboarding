<details wire:click="change_status_accordeon('4')" @if($summary_accordeon[4]==true) open @endif>
    <summary>
    ...
    <div class="summary-content7">
        ...
        <form wire:submit.prevent="save_source_wealth">
            ...
            <textarea class="input-specific" wire:model="other_source_wealth" style="position: relative; left: 5px; right: 693px; top: 270px; width: 450px"></textarea>
            ...
            <a href="#">
                <button class="button-update-summary4" style="position: relative; left: 150px; right: 693px; top: 300px;" onclick="confirm('{{ __('translation.sourcewealth.message.alert') }}') || event.stopImmediatePropagation()" type="submit">{{ 'Update' }}</button>
            </a>
