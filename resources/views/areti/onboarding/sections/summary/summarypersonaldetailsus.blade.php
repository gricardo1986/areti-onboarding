<details wire:click="change_status_accordeon('0')" @if($summary_accordeon[0]==true) open @endif>
    <summary>
        <span class="summary-title">Personal details US PERSON</span>
    ...
    <div class="summary-content2">
        ...
        <form wire:submit.prevent="save_personal_details">
            ...
            <div class="Grupo-LastName">
                ...
                <select class="Country-code2" style=" padding-left: 10px; padding-right: 10px; position:absolute;top:153px; left: 330px; right: 447px;bottom: 465px; " wire:model='country_birth_id' id="">
            ...
            <div class="Group-phone-Number-Summary">
                ...
                <?php 
                    ...
                    <input class="Input7" type="text" wire:model="social_security_number" placeholder="XX-XXX-XXXX"
                        ...
                        style=" padding-left: 10px; padding-right: 10px; width: 460px; position: absolute; top: 240px; left: 95px;" required
                    >
            ...
            <span class="Upload-driver-license"  style=" font-size: 11px; position: absolute; top:405px; left: 95px;">
                Please upload your driver license here.
            </span>
            ...
            @if($document_primary)
                @foreach($document_primary as $dp)
                    <div class="view-File" wire:key="yes{{$dp->id}}" style="width: 460px;height: 34px;position: absolute; left:95px;top:505px">
