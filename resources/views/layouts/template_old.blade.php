    ...
    <script>
      $(document).ready(function(){
        ...
        $(".select_ul li").click(function(){
          var currentele = $(this).html(); //console.log(currentele);
          var anterior=$(".default_option li").html(); //console.log(anterior);
          $(".default_option li").html(currentele);
          $(".select_ul li").html(anterior);
...
<body>
    ...
    <div class="block-country">
        ...
        <svg
            class="lineas-de-colores"
            width="1250"
            height="4"
            viewBox="0 0 1520 4"
            fill="none"
            xmlns="http://www.w3.org/2000/svg">
            <path d="M253.329 4H0V5.00679e-06H253.329V4Z" fill="#F4D446" />
            <path d="M506.666 4H253.337V5.00679e-06H506.666V4Z" fill="#93A83F" />
            <path d="M759.996 4H506.667V5.00679e-06H759.996V4Z" fill="#E69139" />
            <path d="M1013.33 4H760.004V5.00679e-06H1013.33V4Z" fill="#3F8BBA" />
            <path d="M1266.66 4H1013.33V5.00679e-06H1266.66V4Z" fill="#5D73AC" />
            <path d="M1520 4H1266.67V5.00679e-06H1520V4Z" fill="#93A83F" />
        </svg>
        <!-- Fin: lineas Multicolor -->

        <!-- Inicio: Terminos y condiciones  -->
        <div class="privacy-policy">Privacy Policy</div>
        <div class="accessibility-statement">Accessibility Statement</div>
        <div class="terms-of-use">Terms of Use</div>
        <!-- Fin: Terminos y condiciones  -->

        <!-- Inicio: Derechos de autor  -->
        <div class="--2022-aretibank--all-rights-reserved">
